...
<div class="content-wrapper">
  ...
  <form action="{{ url('/admin/save-termsofuse') }}/@if(!empty($data)){{$data[0]->id}}@else{{'tocken'}} @endif" method="post" enctype="multipart/form-data"> 
  {{ csrf_field() }}
  <div class="row">
        <div class="col-md-12">
          <!-- Custom Tabs -->
            ...
            <div class="form-group">
              ...
              <!-- <div class="tab-pane" id="tab_3">
                <div class="form-group">
                  ...
                  <img src="{{url('public/images/banner')}}/{{$data[0]->image}}">
                  @endif
