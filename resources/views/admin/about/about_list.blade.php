        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <!-- <a href="{{url('/admin/add-new-about')}}/tocken" class="btn btn-success pull-right">Add New</a> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$i}}</td>
                  <td>{!!$datas->heading!!}</td>
                  <td><img src="{{url('public/images/about')}}/{{$data[0]->image}}" height="40px;"></td>
                  <td> <a href="{{url('/admin/edit-about')}}/{{$datas->id}} "  class="btn btn-sm btn-info"><i class="glyphicon glyphicon-edit"></i></a>
