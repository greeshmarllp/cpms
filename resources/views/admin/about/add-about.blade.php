...
<div class="content-wrapper">
  ...
  <section class="content">
    <form action="{{ url('/admin/save-about') }}/@if(!empty($data)){{$data[0]->id}}@else{{'tocken'}} @endif" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
      <div class="row">
        <div class="col-md-12">
          <!-- Custom Tabs -->
          ...
          <div class="tab-pane" id="tab_3">
            <div class="form-group">
               @if(!empty($data[0]->image))
                  <img src="{{url('public/images/about')}}/{{$data[0]->image}}">
                  @endif
