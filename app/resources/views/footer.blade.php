 <!-- /.content-wrapper -->
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2019 <a href="https://adminlte.io">Rexav</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="{{url('theme/bower_components/swal2/sweetalert2.min.js')}}"></script>
